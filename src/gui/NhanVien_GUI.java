...
import view.Employee.BanHangPanel;
import view.Employee.CaLamViecPanel;
import view.Employee.HoaDonPanel;
...
//    private ThanhToanPanel thanhToanPanel;
     ...
     */
    public NhanVien_GUI(UserController userController, SanPhamController sanPhamController, HoaDonController hoaDonController) {
                ...
                if (userController.closeShift(currentShift, soTienDongCa)) {
                    JOptionPane.showMessageDialog(frame,
                            "Ca làm việc đã được đóng thành công!\n" +
                                    "Thời gian kết thúc: " + currentShift.getGioKetThuc() + "\n" +
